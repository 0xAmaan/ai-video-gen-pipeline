...
export const isDOMElement = (el: any): el is HTMLElement => {
  return !!el && (el instanceof Element || el instanceof HTMLElement);
};

export const isTypableElement = (el: HTMLElement): boolean => {
...
export const getPlatformSpecialKey = () => {
  return isAppleDevice() ? "⌘" : "Ctrl";
};

export const getPlatformAlternateKey = () => {
